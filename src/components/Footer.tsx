...
const Footer = () => {
  return (
    <div className='text-gray-600  bg-slate-100 shadow-lg body-font dark:bg-gray-100 dark:text-gray-100'>
      <footer className=" body-font text-gray-600 bg-slate-100 shadow-lg body-font dark:bg-gray-200 dark:text-gray-100">
  <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
      
        <span className="ml-3 text-xl text-pink-500">WearThings.com</span>
      </a>
      <p className="mt-2 text-sm text-gray-500">Premium coding tshirts, hoodies and apparals</p>
    </div>
    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      ...
      <img width={300} height={100} src="/payment.jpeg" alt="payment" />
      </div>
    </div>
  </div>
  <div className="bg-gray-100">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-500 text-sm text-center sm:text-left">© 2024 WearThings —
