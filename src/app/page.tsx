...
export default function Home() {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-pink">wear the code with WearThings.com</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify, subway tile poke farm-to-table.</p>
    </div>
    <div className="flex flex-wrap -m-4">
      <div className="xl:w-1/3 md:w-1/2 p-4 flex">
        <div className="border flex flex-col align-middle justify-center border-gray-200 p-6 rounded-lg">
          <div className="w-10 m-auto h-10 inline-flex items-center justify-center rounded-full bg-pink-100 text-pink-500 mb-4">
